...
import com.nali.list.render.RenderExtraBox;
...
public class ExtraBox extends ItemI
{
...
//	public static DrawScreen DRAWSCREEN;
	...
	public ExtraBox(String[] string_array)
	{
		super(string_array);
...
//		GL11.glTranslatef(0.0F, 0.07357F, 0.0F);
	...
	public void newC()
	{
		RenderExtraBox r = new RenderExtraBox();
					...
					if (nbttagcompound.hasKey(key_id))
					{
						...
						if (ForgeRegistries.ENTITIES.containsKey(resourcelocation))
						{
							try
							{
								...
								{
									itemstack.shrink(1);
									world.spawnEntity(new EntityItem(world, entityplayer.posX, entityplayer.posY, entityplayer.posZ, new ItemStack(ItemRegistry.ITEM_ARRAY[ExtraBox.ID])));
								}
								else
								{
